...
// Config URL template
#define vNonTrackingDomainDefaultName   @"nmrodam"
#define vTrackingDomainDefaultName   @"imrworldwide"
#define vCfgDefaultConfigUrl @"https://cdn-gl."vNonTrackingDomainDefaultName".com/conf/|!nol_appid!|.json?devtypid=|!nol_devtypeid!|&devid=&devname=|!(nol_devname)!|&osver=|!(nol_osversion)!|&sysname=|!(nol_sysname)!|&bid=|!nol_bundleID!|"
